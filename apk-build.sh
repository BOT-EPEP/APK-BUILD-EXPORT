...
proot-distro login ubuntu <<-EOF
  ...
  git clone https://github.com/BOT-EPEP/APK-BUILD-EXPORT/blob/main/apk-build.sh
  ...
  wget https://downloads.tuxfamily.org/godotengine/4.3/beta1/Godot_v4.3-beta1_linux.arm32.zip

  unzip Godot_v4.3-beta1_linux.arm32.zip
  chmod +x Godot_v4.3-beta1_linux.arm32
  rm Godot_v4.3-beta1_linux.arm32.zip
  
  ~/godot/Godot_v4.3-beta1_linux.arm32 --export-release "Android" ./name.apk --headless
